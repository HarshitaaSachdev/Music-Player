...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(0, R.raw.starboy);
        songs.add(1, R.raw.asitwas);
        songs.add(2, R.raw.cruelsummer);
        songs.add(3, R.raw.untilifoundyou);
    ...
    private void songNames() {
        ...
        if (currentIndex == 0) {
            songTitle.setText("Starboy - The Weeknd");
            imageView.setImageResource(R.drawable.starboy);
        }

        if (currentIndex == 1) {
            songTitle.setText("As It Was - Harry Styles");
            imageView.setImageResource(R.drawable.asitwas);
        }
        if (currentIndex == 2) {
            songTitle.setText("Cruel Summer - Taylor Swift");
            imageView.setImageResource(R.drawable.cruelsummer);
        }
        if (currentIndex == 3) {
            songTitle.setText("Until I Found You - Stephen Sanchez");
            imageView.setImageResource(R.drawable.untilifoundyou);
        }
